...
export class Ring {
    ...
    /**
     * Getter for the value that is modified by the Ring
    ...
    /**
     * Getter for the Rings description
    ...
    /**
     * Getter for the ammount of the second modified value of the Ring, if it exists
    ...
    /**
     * Getter for the second value that is modified by the Ring, if it exists
    ...
    /**
     * a method that returns the Ring as a string, to use in the dropdowns
